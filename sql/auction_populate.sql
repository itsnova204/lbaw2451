...
INSERT INTO accounts (username, email, password, registration_date, profile_picture, birth_date, address) VALUES
...
INSERT INTO admins (id) VALUES (3); -- Only the admin_user is an admin
...
INSERT INTO auctions (title, description, start_date, end_date, status, minimum_bid, current_bid, category_id, creator_id, buyer_id) VALUES
...
-- Populate bids table
INSERT INTO bids (amount, date, auction_id, user_id) VALUES
...
INSERT INTO ratings (score, comment, date, auction_id, rater_id, receiver_id) VALUES
...
INSERT INTO comments (text, date, auction_id, user_id) VALUES
('Is the laptop still available?', '2024-10-01 12:00:00', 1, 2),
('What is the condition of the chair?', '2024-10-03 09:00:00', 2, 1);

-- Populate reports table
INSERT INTO reports (reason, date, status, auction_id, user_id) VALUES
...
INSERT INTO notifications (text, date, type, receiver_id) VALUES
